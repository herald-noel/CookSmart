...
import com.example.cooksmart.api.model.instructions.Equipment
import com.example.cooksmart.api.model.instructions.Ingredient
import com.squareup.picasso.Picasso

class DirectionEquipmentAdapter(context: Context, private val list: List<Equipment>) :
    RecyclerView.Adapter<DirectionEquipmentAdapter.ViewHolder>() {
